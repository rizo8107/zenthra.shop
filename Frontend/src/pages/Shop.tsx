...
export default function Shop() {
  ...
  const isPriceFilterAvailable = priceBounds[0] !== priceBounds[1];
  const hasActiveFilters = Boolean(searchTerm.trim()) || category !== 'all' || selectedTags.size > 0 || (isPriceFilterAvailable && !isDefaultPrice) || sortBy !== 'default';
        ...
        <div className="space-y-8">
          ...
          {hasActiveFilters && (
            <div className="flex flex-wrap items-center gap-2">
              ...
              {!isDefaultPrice && isPriceFilterAvailable && (
                <Button
                  variant="secondary"
                  size="sm"
                  className="h-7 rounded-full px-3"

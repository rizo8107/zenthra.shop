...
This document describes the schema for the `coupon_codes` collection in PocketBase, which is used to store coupon codes that can be displayed and auto-filled in the checkout page.

                    ...
                    {sizeOptions.map((sz: any) => {
                      ...
                      return (
                        <button
                          ...
                          className={cn(
                            'rounded-lg border px-3 py-2 text-xs font-medium transition-colors bg-background/80',
                    ...
                    {standardCombos.map((cb: any) => {
                      ...
                      return (
                        <button
                          ...
                          className={cn(
                            'rounded-full border px-3 py-1.5 text-xs font-medium transition-colors bg-background/80',
                            selectedCombo?.value === cb.value
                              ? 'border-blue-600 bg-blue-50 text-blue-700'
                              : 'border-border text-foreground/80 hover:border-blue-400 hover:bg-blue-50/50',
                          )}

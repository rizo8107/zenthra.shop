            ...
            <fieldset disabled={isViewMode} className="flex-1 overflow-y-auto p-6">
              <div className="grid grid-cols-12 gap-6">
                ...
                <div className="col-span-12 lg:col-span-8 space-y-6">
                  ...
                  <div className="space-y-4">
                    <h3 className="font-semibold text-lg">Selling Type</h3>
                    <Card className="border-none shadow-sm">
                                ...
                                <div className="space-y-2">
                                  <div className="flex items-center space-x-2">
                                    <input 
                                      ...
                                      name="selling_type" 
                                      value="in_store"
                                      checked={field.value === 'in_store'}
                                      onChange={() => {
                                        field.onChange('in_store');
                                        form.setValue('tn_shipping_enabled', false);
                                      }}
                                      className="h-4 w-4 border-gray-300 text-blue-600 focus:ring-blue-500"
                                    />
                                    <label htmlFor="st_instore" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                                  ...
                                  <div className="flex items-center space-x-2">
                                    <input 
                                      ...
                                      onChange={() => {
                                        ...
                                        form.setValue('tn_shipping_enabled', true);
                                      }}
                                      className="h-4 w-4 border-gray-300 text-blue-600 focus:ring-blue-500"
                                    />
                                    <label htmlFor="st_online" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                                      Online selling only
                                    </label>
                                  </div>
                                  <div className="flex items-center space-x-2">
                                    <input 
                                      ...
                                      className="h-4 w-4 border-gray-300 text-blue-600 focus:ring-blue-500"
                                    />
                                    <label htmlFor="st_both" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                  ...
                  {/* Variant Section */}
                  <div className="space-y-4">
                    <h3 className="font-semibold text-lg">Variant</h3>
                    <Card className="border-none shadow-sm">
                              ...
                              <div key={s.id} className="rounded-md border p-3 bg-card/40 grid grid-cols-12 gap-3 items-center relative">
                                ...
                                <div className="col-span-12 sm:col-span-2">
                                  <div className="flex items-center gap-2">
                                    ...
                                    />
                                    <span className="text-xs">Use base price</span>
                                  </div>
                                </div>
                                <div className="col-span-12 sm:col-span-2">
                                  {!s.useBasePrice && (
